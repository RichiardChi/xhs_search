...
def _tagui_delta(base_directory = None):
    ...
    tagui_delta_url = base_directory + '\\' + 'rpa_python_' + __version__
    if os.path.isfile(tagui_delta_url): return True
    ...
    for delta_file in delta_list:
        ...
        tagui_delta_url = 'https://github.com/tebelorg/Tump/tree/master/TagUI-Python/' + delta_file
